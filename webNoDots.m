...
%
%   $LastChangedDate: 2012-06-07 17:32:03 -0500 (Thu, 07 Jun 2012) $
...
%--------------------------------------------------------------------------
function handleWarning(messageID, theMessage, warnOnSystemError, warnInDialog)
if warnOnSystemError
    displayWarningMessage(messageID, theMessage, warnInDialog);
end
end

%--------------------------------------------------------------------------
function displayWarningMessage(messageID, theMessage, warnInDialog)
if warnInDialog
    warndlg(theMessage, getString(message('MATLAB:web:DialogTitleWarning')));
else
    warning(messageID, theMessage);
end
end
